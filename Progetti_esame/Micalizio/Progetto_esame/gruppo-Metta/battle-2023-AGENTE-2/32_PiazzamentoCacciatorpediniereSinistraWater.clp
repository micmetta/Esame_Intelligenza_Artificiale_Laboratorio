...
(defmodule PIAZZAMENTO_CACCIATORPEDINIERE_SINISTRA_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_SINISTRA_WATER ?ALL) (export ?ALL))
...
=>
    ...
    ;(x,y-1)(left) – (x,y)(dove sappiamo esserci cella_max) 
    ; e quindi faccio questa assert:
    (assert (piazzamento_cacciatorpediniere_orizzontale (x ?x) (y ?y_col_sinistra_1))) ; per semplicità qui setto solamente la cella da dove partirà il cacciatorpediniere (da sinistra)
)
...
=>
    ...
    ; A QUESTO PUNTO SONO CERTO DI POTER PIAZZARE UNA cacciatorpediniere nelle seguenti posizioni
    ; (x+1,y)(bot) – (x,y)(dove sappiamo esserci cella_max)
    ; e quindi faccio questa assert:
