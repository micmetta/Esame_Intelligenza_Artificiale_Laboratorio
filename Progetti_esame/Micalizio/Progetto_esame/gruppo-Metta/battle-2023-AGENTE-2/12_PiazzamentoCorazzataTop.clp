...
(defmodule PIAZZAMENTO_CORAZZATA_TOP (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_TOP ?ALL) (export ?ALL))

; Questo modulo prova a piazzare una corazzata solo in verticale partendo dalla cella "top" conosciuta e 
...
;;    (slot x_row_sotto_3) ; riga -3 sopra al top
;;)
...
(defrule posizionamento_corazzata_in_verticale_conoscendo_top (declare (salience 26))
    ...
    ;    la bandierina che supporremo corrisponda al primo "middle" partendo dall'alto e quindi deve essere vero che:
    ...
    ;    la bandierina che supporremo corrisponda al secondo “middle” partendo dall'alto e quindi deve essere vero che:
    ...
    (not(k_cell_agent (x ?x_row_sotto_3) (y ?y) (content sconosciuto) (considerato true) (current no)))
...
=>
    ...
    ; (x+3,y)(bot) - (x+2,y) (primo middle) – (x+1,y)(altro middle) – (x,y)( dove sappiamo esserci il top) 
...
=>
    ...
    ;(assert (k_cell_agent (x (+ ?row_bot 3)) (y ?y) (content top) (considerato false))) ; QUI E' DOVE C'E' IL TOP (cella(x,y) E QUINDI QUESTA ASSERT NON SERVE (perchè già è presente in WM la k_cell_agent corrispondente)
