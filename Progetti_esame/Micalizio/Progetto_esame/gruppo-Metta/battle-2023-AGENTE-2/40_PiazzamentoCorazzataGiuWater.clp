...
(defmodule PIAZZAMENTO_CORAZZATA_GIU_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_GIU_WATER ?ALL) (export ?ALL))
...
(deftemplate celle_adiacenti_a_cella_max 
    ...
    (slot x_row_sotto_3) ; riga +3 sotto al cella_max
...
=>
    (assert (celle_adiacenti_a_cella_max (x_row_sotto_1 (+ ?x 1)) (x_row_sotto_2 (+ ?x 2)) (x_row_sotto_3 (+ ?x 3))
...
(defrule posizionamento_corazzata_in_verticale_supponendo_cella_max_top (declare (salience 26))
    ...
    (celle_adiacenti_a_cella_max (x_row_sotto_1 ?x_row_sotto_1) (x_row_sotto_2 ?x_row_sotto_2) (x_row_sotto_3 ?x_row_sotto_3)
    ...
    (k-per-row (row ?x_row_sotto_3) (num ?max_pezzi_row_sopra_3))
    (k-per-row-bandierine-posizionate (row ?x_row_sotto_3) (num ?num_b_row_sopra_3))
    ...
    (not (k-cell (x ?x_row_sotto_3) (y ?y) (content water)))
    ...
    (not (k_cell_agent (x ?x_row_sotto_3) (y ?y) (content ?content) (considerato true) (current no)))
...
=>
    ...
    (assert (piazzamento_corazzata_verticale (x ?x_row_sotto_3) (y ?y))) ; per semplicità qui setto solamente la cella da dove partirà la corazzata (dal basso)
)
...
;   posizionato l'corazzata (Questo agente PREFERSCE CONSERVARE TUTTE LE FIREs per la fase 3)
...
=>
    ...
    (assert (k_cell_agent (x (- ?x_row_bot 3)) (y ?y) (content sconosciuto) (considerato false) (current yes))) ; mi ricordo che devo posizionare una bandierina in cella(x-3,y)
...
(defrule cancello_celle_adiacenti_a_cella_max_ormai_inutili(declare (salience 1))
    ...
    ?cella_da_cancellare <- (celle_adiacenti_a_cella_max (x_row_sotto_1 ?x_row_sotto_1) (x_row_sotto_2 ?x_row_sotto_2) (x_row_sotto_3 ?x_row_sotto_3)
                                                         (y_col_sinistra_1 ?y_col_sinistra_1) (y_col_sinistra_2 ?y_col_sinistra_2) (y_col_sinistra_3 ?y_col_sinistra_3)
                                                         (y_col_destra_1 ?y_col_destra_1) (y_col_destra_2 ?y_col_destra_2) (y_col_destra_3 ?y_col_destra_3))
