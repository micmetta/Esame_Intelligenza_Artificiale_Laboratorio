...
(defmodule PIAZZAMENTO_INCROCIATORE_DESTRA_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_DESTRA_WATER ?ALL) (export ?ALL))
...
(deftemplate celle_adiacenti_a_cella_max  
    ...
    (slot y_col_destra_2) ; colonna +2 a destra della cella_max
)
...
=>
    ...
    (assert (piazzamento_incrociatore_orizzontale (x ?x) (y ?y))) ; per semplicità qui setto solamente la cella da dove partirà la incrociatore (da sinistra)
)
...
=>  
    ...
    (assert (celle_incrociatore_caso1_verticale (x_row_bot ?row_bot_caso1) (x_row_middle_1 (+ ?row_bot_caso1 1)) (x_row_top (+ ?row_bot_caso1 3))))
    (assert (celle_incrociatore_caso2_verticale (x_row_bot ?row_bot_caso2) (x_row_middle_1 (+ ?row_bot_caso2 1)) (x_row_top (+ ?row_bot_caso2 3))))
)
