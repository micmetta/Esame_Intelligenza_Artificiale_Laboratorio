...
(defmodule PIAZZAMENTO_CORAZZATA_DESTRA_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_DESTRA_WATER ?ALL) (export ?ALL))
...
;; 1-in orizzontale (ovviamente VERSO DESTRA, supponendo che la cella_max sia il left)
...
(deftemplate celle_adiacenti_a_cella_max  
    ...
    (slot y_col_destra_3) ; colonna +3 a destra della cella_max
)
