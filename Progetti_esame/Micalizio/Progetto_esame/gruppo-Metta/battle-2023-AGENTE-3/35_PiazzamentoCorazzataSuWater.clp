...
(defmodule PIAZZAMENTO_CORAZZATA_SU_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_SU_WATER ?ALL) (export ?ALL))



;; Sappiamo che nella cella subito sotto rispetto alla cella_max c'è water e quindi l'unico modo per cercare
;; di piazzare una corazzata partendo dalla cella_max (DOVE SONO CERTO DI POTER POSIZIONARE UNA BANDIERINA ma NON SO NULLA SU cosa ci sia al suo 
...
(deftemplate piazzamento_corazzata_orizzontale_cella_max_left
    (slot x)
    (slot y)
)
(deftemplate piazzamento_corazzata_orizzontale_cella_max_right
    (slot x)
    (slot y)
)
(deftemplate piazzamento_corazzata_orizzontale ;; in caso di conflitti sulla dir orizzontale, conterrà comunque il punto di partenda della corazzata che ha vinto lungo la dir orizzontale
    (slot x)
    (slot y)
)
...
=>
    (assert (celle_adiacenti_a_cella_max (x_row_sopra_1 (- ?x 1)) (x_row_sopra_2 (- ?x 2)) (x_row_sopra_3 (- ?x 3))
                                         (y_col_sinistra_1 (- ?y 1)) (y_col_sinistra_2 (- ?y 2)) (y_col_sinistra_3 (- ?y 3))
                                         (y_col_destra_1 (+ ?y 1)) (y_col_destra_2 (+ ?y 2)) (y_col_destra_3 (+ ?y 3))))
)


;; DA QUI PARTE IL CONTROLLO SULLA DIREZIONE VERTICALE.

(defrule posizionamento_corazzata_in_verticale_supponendo_cella_max_bot (declare (salience 26))
    ...
    (test (>= (- ?max_pezzi_col ?num_b_col) 4)) ; controllo se la differenza è maggiore o uguale a 4 (perchè devo considerare anche la bandierina per la cella_max che ancora non ho messo)

    ; con il fatto qui sotto mi prendo tutte le coordinate di tutte le celle_adiacenti_a_cella_max:
    (celle_adiacenti_a_cella_max (x_row_sopra_1 ?x_row_sopra_1) (x_row_sopra_2 ?x_row_sopra_2) (x_row_sopra_3 ?x_row_sopra_3)
                                 (y_col_sinistra_1 ?y_col_sinistra_1) (y_col_sinistra_2 ?y_col_sinistra_2) (y_col_sinistra_3 ?y_col_sinistra_3)
                                 (y_col_destra_1 ?y_col_destra_1) (y_col_destra_2 ?y_col_destra_2) (y_col_destra_3 ?y_col_destra_3))
    ...
    (k-per-row (row ?x_row_sopra_3) (num ?max_pezzi_row_sopra_3))
    (k-per-row-bandierine-posizionate (row ?x_row_sopra_3) (num ?num_b_row_sopra_3))
    ...
    (not (k-cell (x ?x_row_sopra_3) (y ?y) (content water)))
    ...
    (not (k_cell_agent (x ?x_row_sopra_3) (y ?y) (content ?content) (considerato true) (current no)))
...
(defrule posizionamento_corazzata_in_orizzontale_supponendo_cella_max_right (declare (salience 26))
    ...
    (test (>= (- ?max_pezzi_row ?num_b_row) 4)) ; controllo se la differenza è maggiore o uguale a 4 (perchè devo considerare anche la bandierina per la cella_max che ancora non ho messo)
    ...
    ; 5) E inoltre mi devo assicurare che anche tre colonne subito a sinistra possa mettere 
    ;    la bandierina che supporremo corrisponda al left e quindi deve essere vero che:
    (k-per-col (col ?y_col_sinistra_3) (num ?max_pezzi_col_sinistra_3))
    (k-per-col-bandierine-posizionate (col ?y_col_sinistra_3) (num ?num_b_col_sinistra_3))
    (test (>= (- ?max_pezzi_col_sinistra_3 ?num_b_col_sinistra_3) 1))
    ...
    (not (k-cell (x ?x) (y ?y_col_sinistra_3) (content water)))
    ...
    (not (k_cell_agent (x ?x) (y ?y_col_sinistra_3) (content ?content) (considerato true) (current no)))
...
=>
    ...
    ; e quindi faccio questa assert:
    (assert (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?y_col_sinistra_3))) ; per semplicità qui setto solamente la cella da dove partirà la corazzata (da sinistra)
)



(defrule posizionamento_corazzata_in_orizzontale_supponendo_cella_max_left (declare (salience 26))
    ...
    (not (k_cell_agent (x ?x) (y ?y_col_destra_3) (content ?content) (considerato true) (current no)))
...
=>
    ...
    ; e quindi faccio questa assert:
    (assert (piazzamento_corazzata_orizzontale_cella_max_left (x ?x) (y ?y))) ; per semplicità qui setto solamente la cella da dove partirà la corazzata (da sinistra)
)
...
(defrule aggiunta_fatti_per_gestire_solo_il_caso_orizzontale_cella_max_right (declare (salience 25))
    ...
    (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?col_left_caso1))
    (not (piazzamento_corazzata_orizzontale_cella_max_left (x ?x_left) (y ?col_left_caso2)))

=>  
    (assert (piazzamento_corazzata_orizzontale(x ?x) (y ?col_left_caso1)))
)
(defrule aggiunta_fatti_per_gestire_solo_il_caso_orizzontale_cella_max_left (declare (salience 25))

    (piazzamento_corazzata_orizzontale_cella_max_left (x ?x_left) (y ?col_left_caso2))
    (not (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?col_left_caso1)))

=>  
    (assert (piazzamento_corazzata_orizzontale(x ?x_left) (y ?col_left_caso2)))
)
...
;; fact1 -> (piazzamento_corazzata_orizzontale_cella_max_left (cella(x,y-1))
;; fact2 -> (piazzamento_corazzata_orizzontale_cella_max_right (cella(x,y-2))
...
(defrule aggiunta_fatti_per_gestione_conflitti_solo_orizzontale_1 (declare (salience 25))
    ...
    (piazzamento_corazzata_orizzontale_cella_max_left (x ?x) (y ?col_left_caso1))
    (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?col_left_caso2))
...
(defrule vince_orizzontale_caso1 (declare (salience 23))
    ...
    ; 1) devono essere veri questi fatti in WM
    ?piazzamento_caso1 <- (piazzamento_corazzata_orizzontale_cella_max_left (x ?x) (y ?col_left_caso1))
    ?piazzamento_caso2 <- (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?col_left_caso2))
...
;   -	(piazzamento_corazzata_orizzontale (cella(x,y))”  
...
;   posizionata la corazzata (Questo agente PREFERSCE CONSERVARE TUTTE LE FIREs per la fase 3)
...
(defrule vince_verticale (declare (salience 20))
    ...
    ?f_piazzamento_orizzontale <- (piazzamento_corazzata_orizzontale (x ?x) (y ?col_su))
...
(defrule vince_orizzontale_supponendo_cella_max_left (declare (salience 20))
    ...
    (piazzamento_corazzata_orizzontale_cella_max_left (x ?x) (y ?col_left))
...
=>
    ...
    (assert (k_cell_agent (x ?x) (y (+ ?col_left 3)) (content sconosciuto) (considerato false) (current yes))) ; mi ricordo che devo posizionare una bandierina in cella(x,y+3)
...
(defrule vince_orizzontale_supponendo_cella_max_right (declare (salience 20))
    ...
    (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?col_left))
...
=>
    ...
    (assert (k_cell_agent (x ?x) (y (+ ?col_left 3)) (content sconosciuto) (considerato false) (current yes))) ; questa è la cella_max nella quale sto assumendo che ci sia il right in cella(x,y)
...
(defrule vince_verticale_senza_conflitto (declare (salience 10)) ; è mutuamente esclusiva con quella di sotto
    ...
    (not (piazzamento_corazzata_orizzontale (x ?x) (y ?y_col_left))) ; aggiunto
    ?f_piazzamento_verticale <- (piazzamento_corazzata_verticale (x ?x_row_bot) (y ?y))
...
=>
    ...
    (assert (k_cell_agent (x (- ?x_row_bot 3)) (y ?y) (content sconosciuto) (considerato false) (current yes))) ; questa è la cella_max nella quale sto assumendo che ci sia il right in cella(x-3,y)
...
(defrule vince_orizzontale_supponendo_cella_max_left_senza_conflitto (declare (salience 10))
    ...
    (not (piazzamento_corazzata_verticale (x ?row_bot) (y ?y))) ; aggiunto
    ?f_piazzamento_orizzontale <- (piazzamento_corazzata_orizzontale_cella_max_left (x ?x) (y ?col_left))
...
(defrule vince_orizzontale_supponendo_cella_max_right_senza_conflitto (declare (salience 10))
    ...
    (not (piazzamento_corazzata_verticale (x ?row_bot) (y ?y))) ; aggiunto
    ?f_piazzamento_orizzontale <- (piazzamento_corazzata_orizzontale_cella_max_right (x ?x) (y ?col_left))
...
(defrule decremento_corazzata (declare (salience 2))
	?decremento_corazzata <- (decremento_corazzate (cella_corazzata_1 true) (cella_corazzata_2 true) (cella_corazzata_3 true) (cella_corazzata_4 true)) ; tutti e 4 gli slot devono essere a true
    ?corazzata <- (corazzata (celle_con_bandierina $?lista) (mancanti ?m))
=>
...
(defrule cancello_celle_adiacenti_a_cella_max_ormai_inutili(declare (salience 1))
    ...
    ?cella_da_cancellare <- (celle_adiacenti_a_cella_max (x_row_sopra_1 ?x_row_sopra_1) (x_row_sopra_2 ?x_row_sopra_2) (x_row_sopra_3 ?x_row_sopra_3)
                                                         (y_col_sinistra_1 ?y_col_sinistra_1) (y_col_sinistra_2 ?y_col_sinistra_2) (y_col_sinistra_3 ?y_col_sinistra_3)
                                                         (y_col_destra_1 ?y_col_destra_1) (y_col_destra_2 ?y_col_destra_2) (y_col_destra_3 ?y_col_destra_3))
