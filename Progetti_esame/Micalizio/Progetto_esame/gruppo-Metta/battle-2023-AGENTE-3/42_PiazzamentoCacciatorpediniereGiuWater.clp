...
(defmodule PIAZZAMENTO_CACCIATORPEDINIERE_GIU_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_GIU_WATER ?ALL) (export ?ALL))
...
=>
    (assert (celle_adiacenti_a_cella_max (x_row_sotto_1 (+ ?x 1))
...
(defrule posizionamento_cacciatorpediniere_in_verticale_supponendo_cella_max_top (declare (salience 26))
    ...
    (celle_adiacenti_a_cella_max (x_row_sotto_1 ?x_row_sotto_1)
...
=>
    ...
    (assert (piazzamento_cacciatorpediniere_verticale (x ?x_row_sotto_1) (y ?y))) ; per semplicità qui setto solamente la cella da dove partirà la cacciatorpediniere (dal basso)
)
...
(defrule cancello_celle_adiacenti_a_cella_max_ormai_inutili(declare (salience 1))
    ...
    ?cella_da_cancellare <- (celle_adiacenti_a_cella_max (x_row_sotto_1 ?x_row_sotto_1)
                                                         (y_col_sinistra_1 ?y_col_sinistra_1)
                                                         (y_col_destra_1 ?y_col_destra_1))
