...
(defmodule PIAZZAMENTO_CACCIATORPEDINIERE_SU_WATER (import MAIN ?ALL) (import ENV ?ALL) (import AGENT ?ALL) (import GESTORE_SU_WATER ?ALL) (export ?ALL))
...
(deftemplate celle_cacciatorpediniere_caso1_orizzontale
    (slot y_col_left) 
    (slot y_col_right)
)
(deftemplate celle_cacciatorpediniere_caso2_orizzontale
    (slot y_col_left) 
    (slot y_col_right)
)
...
(deftemplate piazzamento_cacciatorpediniere_orizzontale_cella_max_left
    (slot x)
    (slot y)
)
(deftemplate piazzamento_cacciatorpediniere_orizzontale_cella_max_right
    (slot x)
    (slot y)
)
(deftemplate piazzamento_cacciatorpediniere_orizzontale ;; in caso di conflitti sulla dir orizzontale, conterrà comunque il punto di partenda della cacciatorpediniere che ha vinto lungo la dir orizzontale
    (slot x)
    (slot y)
)
...
(defrule posizionamento_cacciatorpediniere_in_verticale_supponendo_cella_max_bot (declare (salience 26))
    ...
    (celle_adiacenti_a_cella_max (x_row_sopra_1 ?x_row_sopra_1)
                                 (y_col_sinistra_1 ?y_col_sinistra_1)
...
=>
    ...
    (assert (piazzamento_cacciatorpediniere_verticale (x ?x) (y ?y))) ; per semplicità qui setto solamente la cella da dove partirà la cacciatorpediniere (dal basso)
)
...
(defrule posizionamento_cacciatorpediniere_in_orizzontale_supponendo_cella_max_right (declare (salience 26))
...
=>
    ...
    ; e quindi faccio questa assert:
    (assert (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?y_col_sinistra_1))) ; per semplicità qui setto solamente la cella da dove partirà la cacciatorpediniere (da sinistra)
)
...
=>
    ...
    ; e quindi faccio questa assert:
    (assert (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x) (y ?y))) ; per semplicità qui setto solamente la cella da dove partirà la cacciatorpediniere (da sinistra)
)
...
(defrule aggiunta_fatti_per_gestire_solo_il_caso_orizzontale_cella_max_right (declare (salience 25))
    ...
    (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?col_left_caso1))
    (not (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x_left) (y ?col_left_caso2)))

=>  
    (assert (piazzamento_cacciatorpediniere_orizzontale(x ?x) (y ?col_left_caso1)))
)
(defrule aggiunta_fatti_per_gestire_solo_il_caso_orizzontale_cella_max_left (declare (salience 25))

    (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x_left) (y ?col_left_caso2))
    (not (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?col_left_caso1)))

=>  
    (assert (piazzamento_cacciatorpediniere_orizzontale(x ?x_left) (y ?col_left_caso2)))
)
...
;; fact1 -> (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (cella(x,y-1))
;; fact2 -> (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (cella(x,y-2))
...
(defrule aggiunta_fatti_per_gestione_conflitti_solo_orizzontale_1 (declare (salience 25))
    ...
    (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x) (y ?col_left_caso1))
    (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?col_left_caso2))
...
=>  
    ...
    (assert (celle_cacciatorpediniere_caso1_orizzontale (y_col_left ?col_left_caso1) (y_col_right (+ ?col_left_caso1 1))))
    (assert (celle_cacciatorpediniere_caso2_orizzontale (y_col_left ?col_left_caso2) (y_col_right (+ ?col_left_caso2 1))))
)
...
(defrule gestione_conflitto_solo_orizzontale (declare (salience 24))
    ...
    ?celle_cacciatorpediniere_caso1 <- (celle_cacciatorpediniere_caso1_orizzontale (y_col_left ?col_left_caso1) (y_col_right ?col_right_caso1))
    ...
    ?celle_cacciatorpediniere_caso2 <- (celle_cacciatorpediniere_caso2_orizzontale (y_col_left ?col_left_caso2) (y_col_right ?col_right_caso2))
...
=>  
    ...
    (bind ?score_orizzontale_caso1 (+ ?diff_col_left_caso1 ?diff_col_right_caso1)) ; questo sarà lo score orizzontale del caso 1)
    ...
    (bind ?score_orizzontale_caso2 (+ ?diff_col_left_caso2 ?diff_col_right_caso2)) ; questo sarà lo score orizzontale del caso 2
...
(defrule vince_orizzontale_caso1 (declare (salience 23))
    ...
    ; 1) devono essere veri questi fatti in WM
    ?piazzamento_caso1 <- (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x) (y ?col_left_caso1))
    ?piazzamento_caso2 <- (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?col_left_caso2))
...
=>  
    ...
    (assert (piazzamento_cacciatorpediniere_orizzontale(x ?x) (y ?col_left_caso1))) ; faccio capire quale direzione orizzontale ha vinto ed è quindi quella che rimarrà
...
=>
    (assert (piazzamento_cacciatorpediniere_orizzontale(x ?x) (y ?col_left_caso2))) ; faccio capire quale direzione orizzontale ha vinto ed è quindi quella che rimarrà
...
; -	Le regole di sotto gestiranno UN CONFLITTO CHE SI VERIFICA QUANDO POSSIAMO PIAZZARE UN cacciatorpediniere 
...
=>  
    ...
    (assert (celle_cacciatorpediniere_verticale (x_row_bot ?row_bot) (x_row_top (- ?row_bot 1)))) ;; DA CORREGGERE OVUNQUEEEEEE !!!!
)
...
(defrule vince_verticale (declare (salience 20))
    ...
    ?f_piazzamento_orizzontale <- (piazzamento_cacciatorpediniere_orizzontale (x ?x) (y ?col_su))
...
(defrule vince_orizzontale_supponendo_cella_max_left (declare (salience 20))
    ...
    (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x) (y ?col_left))
...
(defrule vince_orizzontale_supponendo_cella_max_right (declare (salience 20))
    ...
    (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?col_left))
...
(defrule vince_verticale_senza_conflitto (declare (salience 10)) ; è mutuamente esclusiva con quella di sotto
    ...
    ?f_piazzamento_verticale <- (piazzamento_cacciatorpediniere_verticale (x ?x_row_bot) (y ?y))
...
(defrule vince_orizzontale_supponendo_cella_max_left_senza_conflitto (declare (salience 10))
    ...
    (not (piazzamento_cacciatorpediniere_verticale (x ?row_bot) (y ?y))) ; aggiunto
    ?f_piazzamento_orizzontale <- (piazzamento_cacciatorpediniere_orizzontale_cella_max_left (x ?x) (y ?col_left))
...
(defrule vince_orizzontale_supponendo_cella_max_right_senza_conflitto (declare (salience 10))
    ...
    (not (piazzamento_cacciatorpediniere_verticale (x ?row_bot) (y ?y))) ; aggiunto
    ?f_piazzamento_orizzontale <- (piazzamento_cacciatorpediniere_orizzontale_cella_max_right (x ?x) (y ?col_left))
