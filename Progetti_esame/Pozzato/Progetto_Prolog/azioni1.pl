...
applicabile(su, pos(Riga,Colonna), Gn, Fn, ListaStatiVisitati):- % Riga e Colonna sono 2 variabili di Prolog
    ...
    distanzaManhattan(pos(RigaSopra,Colonna), pos(1,10), H1),
    distanzaManhattan(pos(RigaSopra,Colonna), pos(10,1), H2),
    distanzaManhattan(pos(RigaSopra,Colonna), pos(10,10), H3),
    
    %distanzaEuclidea(pos(RigaSopra,Colonna), pos(1,10), H1),
    %distanzaEuclidea(pos(RigaSopra,Colonna), pos(10,1), H2),
    %distanzaEuclidea(pos(RigaSopra,Colonna), pos(10,10), H3),
...
applicabile(giu, pos(Riga,Colonna), Gn, Fn, ListaStatiVisitati):-
    ...
    %distanzaManhattan(pos(RigaSotto,Colonna), pos(1,5), H1),
    %distanzaManhattan(pos(RigaSotto,Colonna), pos(5,5), H2),
    
    % Calcolo del valore Fn = H1 + H2 + Gn + 1:
    %Fn is H1 + H2 + Gn .

    distanzaManhattan(pos(RigaSotto,Colonna), pos(1,10), H1),
    distanzaManhattan(pos(RigaSotto,Colonna), pos(10,1), H2),
    distanzaManhattan(pos(RigaSotto,Colonna), pos(10,10), H3),

    %distanzaEuclidea(pos(RigaSotto,Colonna), pos(1,10), H1),
    %distanzaEuclidea(pos(RigaSotto,Colonna), pos(10,1), H2),
    %distanzaEuclidea(pos(RigaSotto,Colonna), pos(10,10), H3),
...
applicabile(destra, pos(Riga,Colonna), Gn, Fn, ListaStatiVisitati):-
    ...
    %Fn is H1 + H2 + Gn .
    distanzaManhattan(pos(Riga,ColonnaDestra), pos(1,10), H1),
    distanzaManhattan(pos(Riga,ColonnaDestra), pos(10,1), H2),
    distanzaManhattan(pos(Riga,ColonnaDestra), pos(10,10), H3),

    %distanzaEuclidea(pos(Riga,ColonnaDestra), pos(1,10), H1),
    %distanzaEuclidea(pos(Riga,ColonnaDestra), pos(10,1), H2),
    %distanzaEuclidea(pos(Riga,ColonnaDestra), pos(10,10), H3),
...
applicabile(sinistra, pos(Riga,Colonna), Gn, Fn, ListaStatiVisitati):-
    ...
    % Calcolo dist. Manhattan verso ogni uscita:
    distanzaManhattan(pos(Riga,ColonnaSinistra), pos(1,10), H1),
    distanzaManhattan(pos(Riga,ColonnaSinistra), pos(10,1), H2),
    distanzaManhattan(pos(Riga,ColonnaSinistra), pos(10,10), H3),

    % Calcolo dist. Euclidea verso ogni uscita:
    %distanzaEuclidea(pos(Riga,ColonnaSinistra), pos(1,10), H1),
    %distanzaEuclidea(pos(Riga,ColonnaSinistra), pos(10,1), H2),
    %distanzaEuclidea(pos(Riga,ColonnaSinistra), pos(10,10), H3),
